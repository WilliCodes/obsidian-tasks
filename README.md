...
If the `Link done dates` setting is activated, the date will be an internal link: `✅ [[2021-04-09]]`.
...
If the `Link due dates` setting is activated, the date will be an internal link: `📅 [[2021-04-09]]`.
